...
class BaseModel():
    ...
    def model_to_device(self, net):
        ...
        or DataParallel, only if parameters require gradients.
        ...
        if any(param.requires_grad for param in net.parameters()):
            ...
            # If no parameters require gradients, skip DDP and DP
            print("No parameters require gradients, skipping DDP/DP wrapping.")
